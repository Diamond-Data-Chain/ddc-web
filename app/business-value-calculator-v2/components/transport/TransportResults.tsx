...
type TransportResultsData = ReturnType<
  typeof calculateTransportAssessment
>;

type Props = {
  inputs: TransportInputs;
  results: TransportResultsData;
};
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <h2 className="mt-3 text-3xl font-semibold">
            Transport & Logistics assessment results
          </h2>
        </div>
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        <Card index={2} title="Estimated DDC implementation scope">
          <div className="space-y-2 text-sm text-slate-200">
            <div>{results.scope.logisticsSites} sites</div>
            <div>
            ...
            <div>
              {results.scope.vehicleIntegrationGroups} fleet/asset integration groups
            </div>
        ...
        <Card index={10} title="Secondary reconstruction benefit">
        ...
        <Card index={11} title="Systems requiring replacement">
          ...
          <div className="mt-2 text-sm leading-6 text-slate-400">
            Existing TMS, WMS, fleet-management, telematics, GPS, temperature-monitoring and other logistics systems remain in place. DDC adds an independent verifiable operational record layer.
          </div>
        </Card>
      </div>
