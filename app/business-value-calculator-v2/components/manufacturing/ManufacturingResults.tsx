...
type ManufacturingResultsData = ReturnType<
  typeof calculateManufacturingAssessment
>;

type Props = {
  inputs: ManufacturingInputs;
  results: ManufacturingResultsData;
};
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <h2 className="mt-3 text-3xl font-semibold">
            Manufacturing assessment results
          </h2>
        </div>
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        <Card index={2} title="Estimated DDC implementation scope">
          <div className="space-y-2 text-sm text-slate-200">
            <div>{results.scope.productionSites} sites</div>
            <div>
            ...
            <div>
              {results.scope.machineIntegrationGroups} machine/device groups
            </div>
        ...
        <Card index={11} title="Systems requiring replacement">
          ...
          <div className="mt-2 text-sm leading-6 text-slate-400">
            Existing ERP, MES, QMS, WMS, CMMS and other operational systems remain in place. DDC adds an independent governance and operational record layer.
          </div>
        </Card>
      </div>
