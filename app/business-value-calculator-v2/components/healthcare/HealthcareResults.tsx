...
type HealthcareResultsData = ReturnType<
  typeof calculateHealthcareAssessment
>;

type Props = {
  inputs: HealthcareInputs;
  results: HealthcareResultsData;
};
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        <Card index={2} title="Estimated DDC implementation scope">
          <div className="space-y-2 text-sm text-slate-200">
            <div>{results.scope.clinicalSites} sites</div>
            <div>
            ...
            <div>
              {results.scope.deviceIntegrationGroups} medical-device integration groups
            </div>
        ...
        <Card index={11} title="Systems requiring replacement">
          ...
          <div className="mt-2 text-sm leading-6 text-slate-400">
            Existing EHR, laboratory, imaging, pharmacy, medical-device and other clinical systems remain in place. DDC adds an independent verifiable operational record layer.
          </div>
        </Card>
      </div>
