...
import type { EnergyInputs } from "../../../business-value-calculator/energyValueModel";
  ...
  return (
    <div className="grid gap-8 xl:grid-cols-2">
      <section className="rounded-[28px] border border-amber-500/30 bg-slate-900/65 p-6 md:p-8">
        ...
        <div className="mt-8 grid gap-7">
          ...
          <NumberField
            ...
            helper="Current manual asset, meter, maintenance, outage and operational-record workload."
      ...
      <section className="rounded-[28px] border border-amber-500/30 bg-slate-900/65 p-6 md:p-8">
        ...
        <h2 className="mt-3 text-3xl font-semibold">
          When an outage or operational incident requires review
        </h2>

        <div className="mt-8 grid gap-7">
          <NumberField
            label="Annual outages / incidents / operational reviews"
            helper="Used only for the secondary reconstruction and investigation calculation."
            value={inputs.annualOutagesIncidentsReviews}
            suffix="/year"
            onChange={(value) =>
              update("annualOutagesIncidentsReviews", value)
            }
          />

          <NumberField
            label="Average people involved per review"
            helper="People normally required to reconstruct one outage, asset or operational incident."
          ...
          <NumberField
            ...
            helper="Current time spent per person reconstructing one operational event."
