...
type EnergyResultsData =
  ReturnType<typeof calculateEnergyAssessment>;

type Props = {
  inputs: EnergyInputs;
  results: EnergyResultsData;
};
...
export default function EnergyResults({
  inputs,
  results,
}: Props) {
  const exportJson = () => {
    ...
    link.href = url;
    link.download =
      `DDC-Energy-Utilities-Assessment-${new Date()
        .toISOString()
        .slice(0, 10)}.json`;
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <h2 className="mt-3 text-3xl font-semibold">
            Energy & Utilities assessment results
          </h2>
        </div>
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        <Card index={2} title="Estimated DDC implementation scope">
          <div className="space-y-2 text-sm text-slate-200">
            <div>
              {results.scope.operationalSites} operational sites / facilities
            </div>
            ...
            <div>
              {results.scope.integrationGroups} asset / meter integration groups
            </div>
        ...
        <Card index={7} title="Estimated recurring annual benefit">
          <div
            className={
              results.value.recurringAnnualBenefitUsdt >= 0
        ...
        <Card
          index={10}
          title="Secondary outage & incident reconstruction benefit"
        >
        ...
        <Card index={11} title="Systems requiring replacement">
          ...
          <div className="mt-2 text-sm leading-6 text-slate-400">
            Existing SCADA, asset-management, meter-data,
            outage-management, GIS, maintenance, IoT and other
            operational systems remain in place. DDC adds an
            independent verifiable operational record layer.
          </div>
        </Card>
      </div>
