...
export default function TeamDdcTokenPage() {
 return (
 <main className="min-h-screen bg-black text-amber-50">
 <div className="mx-auto max-w-7xl px-4 py-8">
 <div className="mb-6 flex items-center justify-between gap-4">
 <div>
 <h1 className="text-2xl font-semibold text-amber-200">Team DDC Coin Allocation</h1>
 <p className="mt-1 text-sm text-amber-100/70">Focused Team allocation view.</p>
 </div>
 <Link
 href="/#tokenomics"
 ...
 <SingleAllocationVesting allocation="TEAM" />
 </div>
 </main>
 );
}
