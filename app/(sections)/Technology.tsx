...
export default function Technology() {
  return (
    <section id="technology" className="py-16 border-t border-slate-800 scroll-mt-24">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          {techCards.map((card, idx) => (
            ...
            >
              <div className="min-h-[230px] rounded-xl bg-slate-800/60 flex items-center justify-center overflow-visible">
                {card.title === "Layered Structure" ? (
