  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-24 text-slate-200">
      ...
      <div className="mt-8 space-y-6 text-slate-300">
        ...
        <p>
          Public blockchain activity may be permanently visible and independently verifiable.
        </p>
        ...
        <p>
          By using the platform, users acknowledge the transparent and immutable nature
