...
export default function MyRecordPage() {
 ...
 return (<main className="min-h-screen bg-black text-amber-50">
 {toast && (
 <div
 ...
 <input
 className="w-full max-w-md rounded-xl border border-amber-500/40 bg-black/40 px-3 py-2 text-sm text-amber-200"
 ...
 className="rounded-xl border border-amber-500/40 bg-black/40 px-3 py-2 text-sm text-amber-200"
 >
 ...
 <button
 onClick={() => load()}
 className="inline-flex items-center justify-center rounded-full border border-amber-500/40 bg-black/40 px-4 py-2 text-sm hover:bg-black/30/40 transition"
 >
 ...
 <div className="rounded-2xl border border-amber-500/30 bg-black/30 p-4">
 <div className="text-xs uppercase tracking-wider text-amber-100/70">Paid USDT</div>
 ...
 <div className="mt-4 flex items-center justify-between gap-3 text-xs text-amber-100/70">
 <div>Total records: {count}</div>
 <div className="flex items-center gap-2">
 <button
 className="rounded-full border border-amber-500/40 bg-black/40 px-3 py-1 hover:bg-black/30/40 disabled:opacity-50"
